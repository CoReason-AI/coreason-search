...
def test_user_context_minimal() -> None:
    ...
    ctx = UserContext(user_id="user1", email="user1@example.com")
...
def test_user_context_full() -> None:
    ...
    ctx = UserContext(
        ...
        claims={"project_context": "proj_alpha"},
        scopes=["read", "write", "admin"],
    )
    assert ctx.claims.get("project_context") == "proj_alpha"
...
def test_search_request_type_mismatch() -> None:
    ...
    ctx_dict = {"user_id": "user5", "email": "user5@example.com"}
